    ...
    <div class="container-fluid" style="margin-top:4%;">
	 <div class="row clearfix">
		<div class="col-xs-12 col-sm-12 col-md-6 column">
			<div class="row clearfix">
				<div class="col-md-12 column" style="margin-top:40%;padding-left:;">
		   ...
		   <div class="forms">
				  ...
				  <div class="container" style="width:80%;background-color:white;">
				   ...
				   <br>
					...
					<form class="form-horizontal" action="doctorRegister.register" name="form"  style="margin-left:11%;padding-right:%;padding:%;" enctype="multipart/form-data" onSubmit="return doctor();" method="post">
					
					   <div class="container" style="width:100%;">
						<div class="form-group">
							 <!--<label for="inputPassword3" class="col-sm-2 control-label">Password</label>-->
							<div class="col-sm-10">
								<input class="form-control" id="inputPassword3" name="username" type="text" data-toggle="tooltip" data-placement="top" title="Enter your user name" placeholder="Unique user name" onchange="checkUserName(1);" required/><span class="error-message" id="user1" data-value="1" ></span><span class="error-message" id="user"></span>
							</div>
						</div>
						<div class="form-group">
							 <!--<label for="inputPassword3" class="col-sm-2 control-label">Password</label>-->
						...
						<!-- <div class="form-group" >
							...
							<select name="bloodgroup"   class="form-control" >
	  						...
	  						</select><span class="error-message" id="bloodgroup"></span>
	  						</div>
	  					</div> -->
							 ...
							 <!--<label for="inputPassword3" class="col-sm-2 control-label">Password</label>-->
							<div class="col-sm-10">
								<input class="form-control" name=qualification id="inputPassword3" type="text" data-toggle="tooltip" data-placement="top" title="Enter your qualification" placeholder="Your Qualification" required/>
							<span class="error-message" id="qualification"></span></div>
						</div>
						<div class="form-group">
							 <!--<label for="inputPassword3" class="col-sm-2 control-label">Password</label>-->
							<div class="col-sm-10">
								<input class="form-control" name=speciality id="inputPassword3" type="text" data-toggle="tooltip" data-placement="top" title="Enter your speciality" placeholder="Specialty" required/>
							<span class="error-message" id="speciality"></span>
						</div>
						</div>
						<div class="form-group">
							 
							<div class="col-sm-10">
								<input class="form-control" name=worklocation id="inputPassword3" type="text" data-toggle="tooltip" data-placement="top" title="Enter your work location" placeholder="Your Work Location" required/>
							<span class="error-message" id="worklocation"></span></div>
						</div>
                   <div class="form-group">
                      <div class="col-sm-10">
                          <textarea class="form-control" rows="2"  name=address1 data-toggle="tooltip" data-placement="top" title="Enter your Address1" placeholder="Address1" required></textarea>
                        <span class="error-message" id="address1"></span></div>
                   ...
                   <div class="form-group">
                      <div class="col-sm-10">
                          <textarea class="form-control" rows="2" name=address2 data-toggle="tooltip" data-placement="top" title="Enter your Address2" placeholder="Address2" required></textarea>
                       <span class="error-message" id="address2"></span> </div>

                       </div>
                       <div class="form-group">
							 <!--<label for="inputPassword3" class="col-sm-2 control-label">Password</label>-->
							<div class="col-sm-10">
								<input class="form-control" name=landmark id="inputPassword3" type="text" data-toggle="tooltip" data-placement="top" title="Enter your landmark" placeholder="Your Landmark" required/>
							<span class="error-message" id="landmark"></span></div>
						</div>
						<!-- <div class="form-group">
							 <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
							<div class="col-sm-10">
								<input class="form-control" id="inputPassword3" name=city type="text" data-toggle="tooltip" data-placement="top" title="Enter your City name" placeholder="Your City" required/>
							<span class="error-message" id="city"></span></div>
						</div> -->
						...
						<div class="form-group">
							 <!--<label for="inputPassword3" class="col-sm-2 control-label">Password</label>-->
							<div class="col-sm-10">
								<input class="form-control" id="inputPassword3" type="number" name=pincode data-toggle="tooltip" data-placement="top" title="Enter your pincode" placeholder="Your Pincode" required/>
							<span class="error-message" id="pincode"></span></div>
						</div>
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel" style="font-family:;">
