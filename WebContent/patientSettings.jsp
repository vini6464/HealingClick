...
$(document).ready(function(){
	...
	document.getElementById("privacy").value = "${patient.privacy}";
});
	...
	<div class="container" style="margin-top: 2%;">
		<div class="row clearfix">
			<div class="col-md-12 column">
				...
				${error}${success}
					<form class="form-horizontal" name="form" role="form" action="changepassword.login" onSubmit="return comparepassword();" method="post">
