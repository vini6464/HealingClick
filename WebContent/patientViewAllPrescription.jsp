		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				...
				<div class="col-md-2 column"></div>
					...
					<div class="no_message"> No Prescriptions are Prescribed For You. </div>
					</c:if>
					...
					<c:forEach var="prescription" items="${prescriptions}">
						...
						<div class="panel panel-default">
							...
							<div class="panel-heading">
								<h5 class="presctitle panel-title">
									  <c:if test="${not empty prescription.doctorName}">
										...
										<c:if test="${empty prescription.doctorName}">
							...
							<div class="panel-body">
								...
								<table class="table table-condensed" style="margin-top:;">
								<tr>
