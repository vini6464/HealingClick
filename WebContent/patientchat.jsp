                	...
                	$.ajax({
                		...
                		success : function(result) {
                			if(result>0)
                                ...
                                element = element + '<div class="popup-head-left">'+ name +'<span class="glyphicon glyphicon-one-fine-dot pull-left" style="color:green;" id="active'+ result +'" ></span>&nbsp;&nbsp;&nbsp;<span id="notactive'+ result +'" style="font-size:0.6em;padding-top:10px;"></span></div>';
	...
	$.ajax({
		...
		success : function(result) {
			...
			for ( var i = 0; i < d.length; i++) {
                ...
                '<a href=javascript:register_popup("Dr.'+d[i].firstName+'&nbsp;'+d[i].lastName+'",'+d[i].id+',2);>'+
            ...
            '</div>';
				...
				html = html +'<div class="sidebar-name"> '+
                '<a href=javascript:register_popup("'+name+'",'+d[i].id+',4);>'+
                   ' <img width="30" height="30" src='+d[i].image+' />'+
		...
		success : function(result) {
			...
			for ( var i = 0; i < d.length; i++) {
				if(d[i].doctorId != 0)
				{
					...
					html = html +'<div class="sidebar-name"> '+
	                '<a href=javascript:register_popup("Dr.'+name+'",'+d[i].doctorId+',2);>'+
				...
				html = html +'<div class="sidebar-name"> '+
	            '<a href=javascript:register_popup("'+name+'",'+d[i].pharmacyId+',4);>'+
	               ' <img width="30" height="30" src='+d[i].image+' />'+
		...
		success : function(result) {
			...
			if(result!="")
				...
				for ( var i = 0; i < d.length; i++) {
					if(d[i].doctorId != 0)
					{
						register_popup("Dr."+d[i].doctorName ,d[i].doctorId ,2);
					}
					
					if(d[i].pharmacyId != 0)
					{
						register_popup(d[i].pharmacyName ,d[i].pharmacyId ,4);
					}	
				}
				}
