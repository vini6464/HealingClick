							...
							<div class="panel-body">
								...
								<table class="table" style="margin-top: 2%;">
									<tr>
										<td class="field-label col-xs-3 active"><label>Total
												Cost:</label></td>
										<td class="col-md-9">${order.totalCost}Rs. (Including ${spharmacy.deliveryCharge}Rs deliveryCharge and ${spharmacy.discount}% discount)</td>
									</tr>
									<tr>
										<td class="field-label col-xs-3 active"><label>
								...
								<table class="table">
									<tr>
										...
										<td class="col-md-9">${order.pharmacyName}</td>
									</tr>
									<tr>
										<td class="field-label col-xs-3 active"><label>
												Contact:</label></td>
								...
								<form action="order.order" method="post">
									<div class="panel-footer">
										<div class="row">
											...
											<div class="col-xs-3 col-sm-3 col-md-3 column">
												<a href="pharmacy.home" class="btn btn-info btn-block btn-sm"
										...
										<form action="payuform.jsp" method="post" name="payuForm">
											...
											<table class="hidden"> 
												...
												<tr>
													...
													<td>First Name:</td>
													<td><input name="firstname" id="firstname" value="${order.pharmacyName}" /></td>
												</tr>
												<tr>
													<td>Email:</td>
