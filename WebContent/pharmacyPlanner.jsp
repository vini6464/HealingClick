...
$( document ).ready(function() {
	 var insert = "${insert}";
		if(insert == 1)
			{
				window.history.pushState("", "", 'appointment.pharmacy');
			}
			...
			<div class="modal-content">
				...
				<span id="errortime" style="color:red;"></span>
					<form class="form-horizontal" action="save.appointment" name="form"
						...
						<table class="table" style="margin-top: 2%;border:2px solid white;" >
						...
						<button type="button" class="btn btn-default btn-info btn-sm" data-dismiss="modal">Close</button> <input class="btn btn-info btn-sm" type="submit"
							value="Save"> </div>
