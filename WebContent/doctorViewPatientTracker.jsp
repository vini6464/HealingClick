		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				...
				<div class="col-md-2 column"></div>
					...
					<div class="no_message"> No Prescriptions are Prescribed for this patient.</div>
					</c:if>
								...
								<tr>
									...
									<tr>
										<td class="field-label col-xs-3 active"><label>Doctor
												Name</label></td>
										<td class="col-md-9">
										<c:if test="${prescription.doctorId eq doctor.id}">${prescription.doctorName}</c:if>
										<c:if test="${prescription.doctorId ne doctor.id}">	<a href="doctorViewDoctor.profile?id=${prescription.doctorId}">${prescription.doctorName}</a></c:if>
									
											</td>
									</tr>
									</c:if>
									<c:if test="${prescription.doctorId eq 0}">
								
									<tr>
										<td class="field-label col-xs-3 active"><label>
												</label></td>
										<td class="col-md-9">Self Prescription
											</td>
									</tr>
									</c:if>
									<tr>
										...
										<td class="col-md-9"><a href="doctorViewPatient.profile?id=${prescription.patientId}">${prescription.patientName}</a>
											</td>
									</tr>
