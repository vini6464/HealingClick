		...
		success : function(result) {
			if(result!="")
				...
				for ( var i = 0; i < d.length; i++) {
					if(d[i].patientId != 0)
						{
							register_popup(d[i].patientName ,d[i].patientId ,2);
						}
					
					if(d[i].pharmacyId != 0)
					{
						register_popup(d[i].pharmacyName ,d[i].pharmacyId ,3);
					}
					
					if(d[i].doctorId==doctorId)
						{
							if(d[i].otherDoctorId != 0)
								{
								register_popup("Dr."+d[i].otherDoctorName ,d[i].otherDoctorId ,1);
								}
						}
					
					if(d[i].otherDoctorId==doctorId)
					{
						if(d[i].doctorId != 0)
							{
							register_popup("Dr."+d[i].doctorName ,d[i].doctorId ,1);
							}
					}
	...
	$.ajax({
		...
		success : function(result) {
			...
			for ( var i = 0; i < d.length; i++) {
                ...
                '<a href=javascript:register_popup("Dr.'+d[i].firstName+'&nbsp;'+d[i].lastName+'",'+d[i].id+',1);>'+
                   ' <img width="30" height="30" src="'+d[i].image+'" />'+
                    '<span>Dr.'+d[i].firstName+'&nbsp;'+d[i].lastName+'</span> <span class="glyphicon glyphicon-one-fine-dot" style="color:green;"></span>'+
                '</a>'+
            '</div>';
				}
				...
				{
				html = html +'<div class="sidebar-name"> '+
                '<a href=javascript:register_popup("'+d[i].firstName+'&nbsp;'+d[i].lastName+'",'+d[i].id+',2);>'+
                ' <img width="30" height="30" src="'+d[i].image+'" />'+
                    '<span>'+d[i].firstName+'&nbsp;'+d[i].lastName+'</span> <span class="glyphicon glyphicon-one-fine-dot" style="color:green;"></span> '+
                '</a>'+
            '</div>';
				}
                ...
                ' <img width="30" height="30" src="'+d[i].image+'"  />'+
                    '<span>'+d[i].pharmacyName+'</span><span class="glyphicon glyphicon-one-fine-dot" style="color:green;"></span>'+
                '</a>'+
            '</div>';
				}
			}
		...
		success : function(result) {
			...
			for ( var i = 0; i < d.length; i++) {
				if(d[i].patientId != 0)
				{
					...
					html = html +'<div class="sidebar-name"> '+
	                '<a href=javascript:register_popup("'+name+'",'+d[i].patientId+',2);>'+
			...
			html = html +'<div class="sidebar-name"> '+
            '<a href=javascript:register_popup("'+name+'",'+d[i].pharmacyId+',3);>'+
               ' <img width="30" height="30" src='+d[i].image+'  />'+
        ...
        '</div>';
			...
			if(d[i].doctorId==doctorId)
				{
					if(d[i].otherDoctorId != 0)
						{
						var res = d[i].otherDoctorName.split(" ");
						var name ="";
						for (var j = 0; j < res.length; j++) {
							name = name+"&nbsp"+res[j];
						}
						...
						html = html +'<div class="sidebar-name"> '+
		                '<a href=javascript:register_popup("Dr.'+name+'",'+d[i].otherDoctorId+',1);>'+
		                   ' <img width="30" height="30" src='+d[i].otherDoctorImage+'  />'+
		                    '<span>Dr.'+d[i].otherDoctorName+'</span><span class="glyphicon glyphicon-one-fine-dot" style="color:red;"></span>'+
		                '</a>'+
		            '</div>';
						}
				}
			...
			if(d[i].otherDoctorId==doctorId)
			{
				if(d[i].doctorId != 0)
					...
					html = html +'<div class="sidebar-name"> '+
	                '<a href=javascript:register_popup("Dr.'+name+'",'+d[i].doctorId+',1);>'+
	...
	$.ajax({
		...
		success : function(result) {
			...
			for ( var i = 0; i < d.length; i++) {
                ...
                '<a href=javascript:register_popup("Dr.'+d[i].firstName+'&nbsp;'+d[i].lastName+'",'+d[i].id+',1);>'+
                   ' <img width="30" height="30" src='+d[i].image+'  />'+
                    '<span>Dr.'+d[i].firstName+'&nbsp;'+d[i].lastName+'</span><span class="glyphicon glyphicon-one-fine-dot" style="color:red;"></span>'+
                '</a>'+
            '</div>';
				}
                ...
                '<a href=javascript:register_popup("'+d[i].firstName+'&nbsp;'+d[i].lastName+'",'+d[i].id+',2);>'+
                   ' <img width="30" height="30" src='+d[i].image+'  />'+
                    '<span>'+d[i].firstName+'&nbsp;'+d[i].lastName+'</span><span class="glyphicon glyphicon-one-fine-dot" style="color:red;"></span>'+
                '</a>'+
            '</div>';
				}
				...
				html = html +'<div class="sidebar-name"> '+
                '<a href=javascript:register_popup("'+name+'",'+d[i].id+',3);>'+
                   ' <img width="30" height="30" src='+d[i].image+'  /><span class="glyphicon glyphicon-one-fine-dot" style="color:red;"></span>'+
                    '<span>'+d[i].pharmacyName+'</span>'+
                '</a>'+
            '</div>';
				}
			}
