...
var d_a = new Array();
d_a[0]="";
d_a[1]="Nicobar|North and Middle Andaman|South Andaman";
d_a[2]="Adilabad|Anantapur|Chittoor|East Godavari|Guntur|Hyderabad|Kadapa|Karimnagar|Khammam|Krishna|Kurnool|Mahabubnagar|Medak|Nalgonda|Nellore|Nizamabad|Prakasam|Rangareddy|Srikakulam|Visakhapatnam|Vizianagaram|Warangal|West Godavari";
d_a[3]="Anjaw|Changlang| Dibang Valley|East Kameng|East Siang|Kurung Kumey|Lohit|Lower Dibang Valley|Lower Subansiri|Papum Pare|Tawang|Tirap|Upper Siang|Upper Subansiri|West Kameng|West Siang";
d_a[4]="Baksa|Barpeta|Bongaigaon|Cachar|Chirang|Darrang|Dhemaji|Dhubri|Dibrugarh|Goalpara|Golaghat|Hailakandi|Jorhat|Kamrup|Kamrup Metropolitan|Karbi Anglong|Karimganj|Kokrajhar|Lakhimpur|Morigaon|Nagaon|Nalbari|North Cachar Hills|Sivasagar|Sonitpur|Tinsukia|Udalguri";
d_a[5]="Araria|Arwal|Aurangabad|Banka|Begusarai|Bhagalpur|Bhojpur|Buxar|Darbhanga|East Champaran|Gaya|Gopalganj|Jamui|Jehanabad|Kaimur (Bhabua)|Katihar|Khagaria| Kishanganj|Lakhisarai| Madhepura|Madhubani| Munger| Muzaffarpur|Nalanda|Nawada|Patna| Purnea| Rohtas|Saharsa|Samastipur|Saran|Sheikhpura|Sheohar|Sitamarhi|Siwan|Supaul|Vaishali|West Champaran";
d_a[6]="Chandigarh";
d_a[7]="Bastar|Bijapur|Bilaspur|Dhamtari|Durg|Janjgir-Champa|Jashpur|Kabirdham-Kawardha|Korba|Korea|Mahasamund|Narayanpur|Norh Bastar-Kanker|Raigarh|Raipur|Rajnandgaon|South Bastar-Dantewada|Surguja";
d_a[8]="Dadra & Nagar Haveli";
d_a[9]="daman and Diu";
d_a[10]="Central Delhi|East Delhi|New Delhi|North Delhi|North East Delhi|North West Delhi|South Delhi|South West Delhi|West Delhi";
d_a[11]="North Goa|South Goa";
d_a[12]="Ahmedabad|Amreli|Anand|Banaskantha|Bharuch|Bhavnagar|Dahod|Dang|Gandhinagar|Jamnagar|Junagadh|Kheda|Kutch|Mehsana|Narmada|Navsari|Panchmahals|Patan|Porbandar|Rajkot|Sabarkantha|Surat|Surendranagar|Vadodara|Valsad";
d_a[13]="Ambala|Bhiwani|Faridabad|Fatehabad|Gurgaon|Hisar|Jhajjar|Jind|Kaithal|Karnal|Kurukshetra|Mahendragarh|Mewat|Palwal|Panchkula|Panipat|Rewari|Rohtak|Sirsa|Sonipat|Yamunanagar";
d_a[14]="Bilaspur|Chamba|Hamirpur|Kangra|Kinnaur|Kullu|Lahaul & Spiti|Mandi|Shimla|Sirmaur|Solan|Una";
d_a[15]="Anantnag|Baramulla|Budgam|Doda|Jammu|Kargil|Kathua|Kupwara|Leh|Poonch|Pulwama|Rajouri|Samba|Srinagar|Udhampur";
d_a[16]="Bokaro|Chatra|Deoghar|Dhanbad|Dumka|East Singhbhum|Garhwa|Giridih|Godda|Gumla|Hazaribag|Jamtara|Khunti|Koderma|Latehar|Lohardaga|Pakur|Palamu|Ramgarh|Ranchi|Sahibganj|Seraikela-Kharsawan|Simdega|West Singhbhum";
d_a[17]="Bagalkot|Bangalore|Bangalore Rural|Belgaum|Bellary|Bidar|Bijapur|Chamrajanagar|Chickmagalur|Chikballapur|Chitradurga|Dakshina Kannada|Davangere|Dharwad|Gadag|Gulbarga|Hassan|Haveri|Kodagu|Kolar|Koppal|Mandya|Mysore|Raichur|Shimoga|Tumkur|Udupi|Uttara Kannada";
d_a[18]="Alappuzha|Ernakulam|Idukki|Kannur|Kasargod|Kollam|Kottayam|Kozhikode|Malappuram|Palakkad|Pathanamthitta|Thiruvananthapuram|Thrissur|Wayanad";
d_a[19]="Lakshadweep";
d_a[20]="Alirajpur|Anuppur|Ashoknagar|Balaghat|Barwani|Betul|Bhind|Bhopal|Burhanpur|Chhatarpur|Chhindwara|Damoh|Datia|Dewas|Dhar|Dindori|Guna|Gwalior|Harda|Hoshangabad|Indore|Jabalpur|Jhabua|Katni|Khandwa|Khargone|Mandla|Mandsaur|Morena|Narsinghpur|Neemuch|Panna|Raisen|Rajgarh|Ratlam|Rewa|Sagar|Satna|Sehore|Seoni|Shahdol|Shajapur|Sheopur|Shivpuri|Sidhi|Singrauli|Tikamgarh|Ujjain|Umaria|Vidisha";
d_a[21]="Ahmednagar|Akola|Amravati|Aurangabad|Beed|Bhandara|Buldhana|Chandrapur|Dhule|Gadchiroli|Gondia|Hingoli|Jalgaon|Jalna|Kolhapur|Latur|Mumbai City|Mumbai Suburban|Nagpur|Nanded|Nandurbar|Nashik|Osmanabad|Parbhani|Pune|Raigad|Ratnagiri|Sangli|Satara|Sindhudurg|Solapur|Thane|Wardha|Washim|Yavatmal";
d_a[22]="Bishnupur|Chandel|Churachandpur|Imphal East|Imphal West|Senapati|Tamenglong|Thoubal|Ukhrul";
d_a[23]="Williamnagar/Resubelpara|Shillong|Jowai/Khliehriat|Nongpoh|Baghmara|Tura/Ampati|Nongstoin/Mawkyrwat";
d_a[24]="Aizawl|Champhai|Kolasib|Lawngtlai|Lunglei|Mamit|Saiha|Serchhip";
d_a[25]="Dimapur|Kephrie|Kohima|Longleng|Mokokchung|Mon|Peren|Phek|Tuensang|Wokha|Zunheboto";
d_a[26]="Angul|Balangir|Balasore|Bargarh|Bhadrak|Boudh|Cuttack|Deogarh|Dhenkanal|Gajapati|Ganjam|Jagatsinghapur|Jajpur|Jharsuguda|Kalahandi|Kandhamal|Kendrapara|Kendujhar|Khordha|Koraput|Malkangiri|Mayurbhanj|Nabarangpur|Nayagarh|Nuapada|Puri|Rayagada|Sambalpur|Subarnapur|Sundargarh";
d_a[27]="Karaikal|Mahe|Pondicherry|Yanam";
d_a[28]="Amritsar|Barnala|Bathinda|Faridkot|Fatehgarh Sahib|Ferozepur|Gurdaspur|Hoshiarpur|Jalandhar|Kapurthala|Ludhiana|Mansa|Moga|Muktsar|Nawanshahr|Patiala|Rupnagar|Sangrur|SAS Nagar|Tarn Taran";
d_a[29]="Ajmer|Alwar|Banswara|Baran|Barmer|Bharatpur|Bhilwara|Bikaner|Bundi|Chittorgarh|Churu|Dausa|Dholpur|Dungarpur|Hanumangarh|Jaipur|Jaisalmer|Jalore|Jhalawar|Jhunjhunu|Jodhpur|Karauli|Kota|Nagaur|Pali|Pratapgarh|Rajsamand|Sawai Madhopur|Sikar|Sirohi|Sri Ganganagar|Tonk|Udaipur";
d_a[30]="Gangtok|Mangan|Namchi|Geyzing";
d_a[31]="Ariyalur|Chennai|Coimbatore|Cuddalore|Dharmapuri|Dindigul|Erode|Kanchipuram|Kanyakumari|Karur|Krishnagiri|Madurai|Nagapattinam|Namakkal|Perambalur|Pudukkottai|Ramanathapuram|Salem|Sivaganga|Thanjavur|The Nilgiris|Theni|Thoothukudi|Tiruchirappalli|Tirunelveli|Tiruppur|Tiruvallur|Tiruvannamalai|Tiruvarur|Vellore|Viluppuram|Virudhunagar";
d_a[32]="Dhalai|North Tripura|South Tripura|West Tripura";
d_a[33]="Agra|Aligarh|Allahabad|Ambedkar Nagar|Auraiya|Azamgarh|Bagpat|Bahraich|Ballia|Balrampur|Banda|Barabanki|Bareilly|Basti|Bijnor|Budaun|Bulandshahar|Chandauli|Chitrakoot|Deoria|Etah|Etawah|Faizabad|Farrukhabad|Fatehpur|Firozabad|Gautam Buddha Nagar|Ghaziabad|Ghazipur|Gonda|Gorakhpur|Hamirpur|Hardoi|Hathras|Jalaun|Jaunpur|Jhansi|Jyotiba Phule Nagar|Kannauj|Kanpur Dehat|Kanpur Nagar|Kanshiramnagar|Kaushambi|Kheri|Kushinagar|Lalitpur|Lucknow|Maharajganj|Mahoba|Mainpuri|Mathura|Mau|Meerut|Mirzapur|Moradabad|Muzaffarnagar|Pilibhit|Pratapgarh|RaeBareli|Rampur|Saharanpur|Sant Kabir Nagar|Sant Ravidas Nagar|Shahjahanpur|Shravasti|Siddharthnagar|Sitapur|Sonbhadra|Sultanpur|Unnao|Varanasi";
d_a[34]="Almora|Bageshwar|Chamoli|Champawat|Dehradun|Haridwar|Nainital|Pauri Garhwal|Pithoragarh|Rudraprayag|Tehri Garhwal|Udham Singh Nagar|Uttarkashi";
d_a[35]="Bankura|Bardhaman|Birbhum|Cooch Behar|Darjeeling|East Medinipur|Hooghly|Howrah|Jalpaiguri|Malda|Murshidabad|Nadia|North 24 Parganas|North Dinajpur|Purulia|South 24 Parganas|South Dinajpur|West Medinipur";
...
function populateCities(countryElementId, stateElementId ,cityElementId) {
    ...
    cityElement.options[0] = new Option('Select City', '0');
    cityElement.selectedIndex = 0;

    var city_arr = d_a[selectedStateIndex].split("|");
