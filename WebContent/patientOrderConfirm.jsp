							...
							<div class="panel-body">
								...
								<table class="table" style="margin-top: 5%;">
									<tr>
										<td class="field-label col-xs-3 active"><label>Total
												Cost:</label></td>
										<td class="col-md-9">${order.totalCost}Rs. (Including ${pharmacy.deliveryCharge}Rs deliveryCharge and ${pharmacy.discount}% discount)</td>
									</tr>
									<tr>
										<td class="field-label col-xs-3 active"><label>
								...
								<table class="table">
									<tr>
										...
										<td class="col-md-9">${order.patientName}</td>
									</tr>
									<tr>
										<td class="field-label col-xs-3 active"><label>
												Contact:</label></td>
								...
								<form action="order.order" method="post">
									<div class="panel-footer" style="background-color: #e5f8fc;">
										<div class="row">
											...
											<div class="col-xs-3 col-sm-3 col-md-3 column">
												<a href="patient.home" class="btn btn-info btn-block btn-sm"
