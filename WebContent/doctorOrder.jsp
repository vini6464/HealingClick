						...
						<form action="confirm.order?id=${pharmacy.id}" name="order"
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h5 class="panel-title">${pharmacy.pharmacyName}</h5>
								</div>
								<div class="panel-body">
									...
									<div class="row">
										...
										<div class="col-xs-4 col-sm-4 column" style="padding-top: 3px;">
											...
											<input type="file" name="file" style="margin-left:-35px;" accept="image/*"/>
									...
									<div class="row">
										...
										<div class="col-xs-4 col-sm-4 column"
											...
											<label class="radio"> <input type="radio"
												...
												style="color:; letter-spacing: 1px;">Cash on
													Delivery</small>
											</label>
									...
									<div class="row">
										...
										<div class="col-xs-4 col-sm-4 column"
											...
											<label class="radio"> <input type="radio"
												...
												id="optionsRadios1" checked> <i></i><small
												style="color:; letter-spacing: 1px;">Same As Profile
													Address and Contact Details</small>
											</label>
										...
										<div class="col-xs-3 col-sm-3 column"
											...
											<label class="radio"> <input type="radio"
												...
												id="optionsRadios1"> <i></i><small
												style="color:; letter-spacing: 1px;">Different
													Address</small>
											</label>
								...
								<div class="panel-footer">
									<div class="row">
										...
										<div class="col-md-3 column pull-right">
											<input class="btn btn-info btn-block btn-xs" type="submit"
												style="" value="Submit">
										</div>
