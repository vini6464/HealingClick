			...
			<div class="col-md-12 column">
				<div class="row clearfix">
					...
					<div class="col-md-6 column" id="noMedicines">
						<form action="confirm.order?id=${spharmacy.id}" name="order"
							method="post" enctype="multipart/form-data" name="form1">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">${spharmacy.pharmacyName}</h3>
								</div>
                                ...
                                <div class="row">
										...
										<div class="col-xs-4 col-sm-4 column"
											style="margin-left:-35px;padding-top:7px; text-align:">
								...
								<div class="panel-footer">
									<div class="row">
										<div class="col-xs-6 col-sm-8 col-md-8 column"></div>
