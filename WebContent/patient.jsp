...
<script type="text/javascript" src="js/ajax.js"></script><link href='http://fonts.googleapis.com/css?family=Ubuntu' rel='stylesheet' type='text/css'>
		   ...
		   <div class="forms">
				  ...
				  <h4 style="text-align:cEnter;letter-spacing:0.5px;">Please Enter your details</h4>
				   ...
				   <br>
					...
					<form class="form-horizontal" method="post" action="patientRegister.register" name="form"  style="margin-left:11%;padding-right:%;padding:%;" enctype="multipart/form-data" onSubmit="return patient();">
                   ...
                   <div class="form-group">
                      <div class="col-sm-10">
                          <textarea class="form-control" rows="2"  name=address1 data-toggle="tooltip" data-placement="top" title="Enter your address1" placeholder="Address1" required></textarea><span class="error-message" id="address1"></span>
                        </div>
                   ...
                   <div class="form-group">
                      <div class="col-sm-10">
                       ...
                       <div class="form-group">
							 <!--<label for="inputPassword3" class="col-sm-2 control-label">Password</label>-->
							<div class="col-sm-10">
								<input class="form-control" name=landmark id="inputPassword3" type="text" data-toggle="tooltip" data-placement="top" title="Enter your landmark" placeholder="Your Landmark"/><span class="error-message" id="landmark"></span>
							</div>
						</div>
						<!-- <div class="form-group">
							 <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
							<div class="col-sm-10">
								<input class="form-control" id="inputPassword3" name=city type="text" data-toggle="tooltip" data-placement="top" title="Enter your city" placeholder="Your City" required/><span class="error-message" id="city"></span>
							</div>
						</div>
						 -->
						<div class="form-group">
					...
					<!-- 	
						<div class="form-group">
							 <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
							<div class="col-sm-10">
								<input class="form-control" name=landline id="inputPassword3" type="number" data-toggle="tooltip" data-placement="top" title="Enter your landline no" placeholder="Your LandLine" required/><span class="error-message" id="landline"></span>
							</div>
						</div>
						...
						<div class="form-group">
							 <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
							<div class="col-sm-10">
								<input class="form-control" maxlength="10" name=contact1 id="inputPassword3" type="number" data-toggle="tooltip" data-placement="top" title="Enter your emergency contact no1" placeholder="Your Emergency Contact" required/><span class="error-message" id="contact1"></span>
							</div>
						</div>
						<div class="form-group">
							 <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
							<div class="col-sm-10">
								<input class="form-control" maxlength="10" name=contact2 id="inputPassword3" type="number" data-toggle="tooltip" data-placement="top" title="Enter your emergency contact no2" placeholder="Your Emergency Contact" required/><span class="error-message" id="contact2"></span>
							</div>
						</div> -->
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title page_heading" id="myModalLabel" style="font-family:Candara;">
