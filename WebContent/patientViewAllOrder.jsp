	...
	<div class="container" style="margin-top: 4%;">
			...
			<div class="row clearfix">
				...
				<c:if test="${type == 1 }">
								...
								<a href="getAllUrgentOrder.patient" class="btn  btn-block btn-sm"
									type="button"
									id="bactive"
									>Urgent Order</a>
							
								<a href="getAllNormalOrder.patient" class="btn  btn-block btn-sm"
									type="button" id="binactive">Normal Order</a>
							
								<a href="getAllDeliveredOrder.patient" class="btn  btn-block btn-sm"
			...
			<div class="panel panel-default">
				<div class="panel-heading" >
					<h5 class="panel-title" style="letter-spacing:0.8px;text-align:center;">
							...
							<div class="panel-body">
								...
								<table class="table table-condensed">
									<tr>
										...
										<td class="col-xs-8 col-sm-9 col-md-9 column">${order.patientName}</td>
									</tr>
									<tr>
										<td class="field-label col-xs-4 col-sm-3 col-md-3 column  active"><label>
