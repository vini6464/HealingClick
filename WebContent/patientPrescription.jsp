		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				...
				<div class="col-md-2 column"></div>
					...
					<form action="prescriptionSave.patient"
									...
									<table class="table table-condensed" style="margin-top:1%;">
										<%-- <tr>
											<td class="field-label col-xs-3 active"><label>Doctor
													name</label></td>
											<td class="col-md-9"><select name="doctorid"><option value=0>---SELECT----</option><c:forEach var="doctor" items="${doctors}"><option value="${doctor.id}">${doctor.firstName} ${doctor.lastName}</option></c:forEach></select></td>
										</tr> --%>
										<tr>
			...
			<div id=medicine1>
				<input type='button' value='+' id=medicine>
									...
									<table class="table table-condensed" style="margin-top: 2%;">
										...
										<tr>
											<td class="field-label col-xs-3 active"><label>Height(In Feet)
													 </label></td>
											<td class="col-md-9">
												<div class="form-group">
													<input id="exampleInputFile" type="number" name="height" value=0  step="0.0000001"/>

												</div>
											</td>
										</tr>
										<tr>
											<td class="field-label col-xs-3 active"><label>Weight(In Kilo Gram)
													 </label></td>
											<td class="col-md-9">
												<div class="form-group">
													<input id="exampleInputFile" type="number" name="weight" value=0  step="0.001"/>
							...
							<div class="panel-footer">
								<div class="row">
									...
									<!-- <div class="col-md-3 column">
										<a class="btn btn-info btn-block btn-sm" type="button"
