...
<style>
.btn-block{background-color:#f9f9f9;}
		...
		<div class="col-md-12" style="background-color:#00b9bc;height:120px;">
			<div class="row">
				...
				<ul class="img-list">
					...
					<img alt="Bootstrap Image Preview" src="${doctor.image}" class="img-rounded" style="height:130px;width:130px;" onError="this.onerror=null;this.src='image/d.jpg';" /> 
												</li>
												</ul>
				...
				<div class="col-md-8 column col-md-offset-2 col-sm-offset-1 col-xs-offset-1" style="word-wrap:break-word;">
						...
						<div class="panel-body">
						 <c:if test="${doctor.deleted == 0}">
							  <div class="row">
							   <a class="btn btn-success btn-xs" type="button" style="width:%;" href=javascript:register_popup("${doctor.firstName}&nbsp;${doctor.lastName}",${doctor.id},3);>Send Message</a></div>
							</c:if>
				   <br>
			  <br>
